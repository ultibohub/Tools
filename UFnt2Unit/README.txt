...
This tool takes the .ufnt files created by the UFontCreator tool and converts them to pascal units for inclusion in an Ultibo project. See below for usage.
